...
@(struct publication (title authors venue year note links) #:transparent)
...
@(define (make-publication
  ...
  #:note [note '()]
  #:links links)
  (publication title authors venue year note links))

@(define (publications me award)
   (list
    @make-publication[
    ...
    @make-publication[
      ...
      #:venue "EuroSys"
      #:year 2021
      #:note @award{Awarded Best Artifact!}
      #:links (list 
    ...
    @make-publication[
      ...
      #:venue "SIGCOMM"
      #:year 2018
      #:note @award{Awarded Best Student Paper!}
