...
@(define (berkeley make-cafe)
  @(list
  @text{
  @link-cafe[@make-cafe[
    #:name "CoRo"
    #:url "https://www.corocoffee.com/"
    #:address "2322 Fifth Street, Berkeley, CA 9471"
    #:latlon "37.8625, -122.2972"
  ]] and
  @link-cafe[@make-cafe[
    #:name "Artis"
    #:url "https://www.artiscoffee.com/"
    #:address "1717 4th Street, Berkeley, CA 94720"
  ...
  The closest @link-cafe[@make-cafe[
    ...
    #:address "Rockridge Market Hall, 5615 College Ave, Oakland, CA 94618"
  ...
  @link-cafe[@make-cafe[
    ...
    #:address "1816 Euclid Ave, Berkeley, CA 94709"
    #:latlon "37.8758, -122.2604"
  ]]
  <a href="https://www.themindcoffee.com/">Mind</a> 
