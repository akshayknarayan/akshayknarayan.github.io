...
@(define (sf make-cafe)
  ...
  @text{
    @link-cafe[@make-cafe[
      ...
      #:url "http://www.ritualroasters.com/location/mission"
      #:address "1026 Valencia Street San Francisco, CA 94110"
      #:latlon "37.7565, -122.4212"
    ]]
    is probably my favorite cappuccino in San Francisco.
  }
  ...
  @text{
    At SFO airport, T1 has a
    @link-cafe[@make-cafe[
      #:name "Ritual Coffee"
      #:url "https://ritualcoffee.com/location/sfo/"
      #:address "Gate B4, Harvey Milk Terminal 1B, San Francisco, CA 94128"
      #:latlon "37.61379, -122.38519"
      #:show #f
    ]]
    just past security near gate B4, and T2 has an
    @link-cafe[@make-cafe[
      #:name "Napa Farms Market"
      #:url "https://www.flysfo.com/passengers/shop-dine-relax/napa-farms-market"
      #:address "Gate D1 Terminal 2, San Francisco, CA 94128"
  ...
  @text{
    ...
    @link-cafe[@make-cafe[
      ...
      #:address "736 Divisadero Street San Francisco, CA"
    ...
    @link-cafe[@make-cafe[
      ...
      #:address "599 3rd Street San Francisco, CA 94107"
