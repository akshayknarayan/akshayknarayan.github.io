...
@(define (bos make-cafe)
  ...
  @text{
    ...
    @link-cafe[@make-cafe[
      ...
      #:address "505 Washington Street, Boston, MA"
  ...
  @text{
    @link-cafe[@make-cafe[
      ...
      #:address "151 Tremont Street, Boston, MA 02111"
  ...
  @text{
    ...
    @link-cafe[@make-cafe[
      ...
      #:address "594 Cambridge St, Cambridge, MA 02141"
  ...
  @text{
    @link-cafe[@make-cafe[
      ...
      #:address "286 Newbury Street Boston MA 02115"
      #:latlon "42.3490, -71.0845"
    ]]
    is a good option if you're in Back Bay (there is now also a Pavement location in Harvard Square, in the student center). 
    @link-cafe[@make-cafe[
      #:name "Flat Black"
      #:url "https://flatblackcoffee.com/"
      #:address "1170 Washington St, Dorchester Center, MA 02124"
