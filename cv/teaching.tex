...
\noindent
\begin{tabular*}{\textwidth}{@{\hspace{1cm}}l@{\extracolsep{\fill}}r@{}}
\textbf{Computer Networks and the Internet (CSCI 2680)}, Brown University. & \emph{Spring 2026, Fall 2024} \\
\end{tabular*}
\begin{itemize}[leftmargin=1.5cm]
\setlength{\itemsep}{0pt}
  \item Newly-developed graduate seminar course.
  \item Spring 2026: 19 students;  Instructor effectiveness rating: 100\%
